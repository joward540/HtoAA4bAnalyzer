...
// Thu Apr  2 13:59:37 2026 by ROOT version 6.32.13
// from TTree Events/Events
// found on file: /cms/data/store/mc/RunIII2024Summer24NanoAODv15/GluGluH-01J-HToAATo4B_Par-M-35_TuneCP5_13p6TeV_madgraph-pythia8/NANOAODSIM/150X_mcRun3_2024_realistic_v2-v2/2520000/0afb91ad-bf79-4830-ba1a-ebb5b2a0b4b4.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSe[3];   //[nboostedTau]
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSjet[3];   //[nboostedTau]
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSmu[3];   //[nboostedTau]
   ...
   Int_t           nCorrT1METJet;
   Float_t         CorrT1METJet_EmEF[15];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_area[15];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[15];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrDeltaEta[15];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrDeltaPhi[15];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[15];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[15];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawMass[15];   //[nCorrT1METJet]
   ...
   Bool_t          Electron_isEB[7];   //[nElectron]
   Bool_t          Electron_isEcalDriven[7];   //[nElectron]
   ...
   Bool_t          Electron_mvaIso_WPHZZ[7];   //[nElectron]
   ...
   Short_t         Electron_seediEtaOriX[7];   //[nElectron]
   Short_t         Electron_seediPhiOriY[7];   //[nElectron]
   ...
   Float_t         Electron_PreshowerEnergy[7];   //[nElectron]
   ...
   Float_t         Electron_ecalEnergy[7];   //[nElectron]
   Float_t         Electron_ecalEnergyError[7];   //[nElectron]
   Float_t         Electron_energyErr[7];   //[nElectron]
   Float_t         Electron_eta[7];   //[nElectron]
   Float_t         Electron_fbrem[7];   //[nElectron]
   Float_t         Electron_gsfTrketaMode[7];   //[nElectron]
   Float_t         Electron_gsfTrkpMode[7];   //[nElectron]
   Float_t         Electron_gsfTrkpModeErr[7];   //[nElectron]
   Float_t         Electron_gsfTrkphiMode[7];   //[nElectron]
   Float_t         Electron_hoe[7];   //[nElectron]
   Float_t         Electron_ip3d[7];   //[nElectron]
   Float_t         Electron_jetDF[7];   //[nElectron]
   ...
   Int_t           nFatJetPFCand;
   Int_t           FatJetPFCand_pfCandIdx[215];   //[nFatJetPFCand]
   Int_t           FatJetPFCand_jetIdx[215];   //[nFatJetPFCand]
   Int_t           nFsrPhoton;
   ...
   Float_t         GenPart_iso[118];   //[nGenPart]
   Int_t           nGenProton;
   ...
   Int_t           nJet;
   UChar_t         Jet_chMultiplicity[21];   //[nJet]
   UChar_t         Jet_nConstituents[21];   //[nJet]
   UChar_t         Jet_nElectrons[21];   //[nJet]
   UChar_t         Jet_nMuons[21];   //[nJet]
   UChar_t         Jet_nSVs[21];   //[nJet]
   UChar_t         Jet_neMultiplicity[21];   //[nJet]
   Short_t         Jet_electronIdx1[21];   //[nJet]
   Short_t         Jet_electronIdx2[21];   //[nJet]
   Short_t         Jet_muonIdx1[21];   //[nJet]
   Short_t         Jet_muonIdx2[21];   //[nJet]
   Short_t         Jet_svIdx1[21];   //[nJet]
   Short_t         Jet_svIdx2[21];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[21];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[21];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorr[21];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorrNeutrino[21];   //[nJet]
   Float_t         Jet_PNetRegPtRawRes[21];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorr[21];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorrNeutrino[21];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawRes[21];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawCorr[21];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawCorrNeutrino[21];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawRes[21];   //[nJet]
   Float_t         Jet_area[21];   //[nJet]
   Float_t         Jet_btagDeepFlavB[21];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[21];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[21];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[21];   //[nJet]
   Float_t         Jet_btagPNetB[21];   //[nJet]
   Float_t         Jet_btagPNetCvB[21];   //[nJet]
   Float_t         Jet_btagPNetCvL[21];   //[nJet]
   Float_t         Jet_btagPNetCvNotB[21];   //[nJet]
   Float_t         Jet_btagPNetQvG[21];   //[nJet]
   Float_t         Jet_btagPNetTauVJet[21];   //[nJet]
   Float_t         Jet_btagUParTAK4B[21];   //[nJet]
   Float_t         Jet_btagUParTAK4CvB[21];   //[nJet]
   Float_t         Jet_btagUParTAK4CvL[21];   //[nJet]
   Float_t         Jet_btagUParTAK4CvNotB[21];   //[nJet]
   Float_t         Jet_btagUParTAK4Ele[21];   //[nJet]
   Float_t         Jet_btagUParTAK4Mu[21];   //[nJet]
   Float_t         Jet_btagUParTAK4QvG[21];   //[nJet]
   Float_t         Jet_btagUParTAK4SvCB[21];   //[nJet]
   Float_t         Jet_btagUParTAK4SvUDG[21];   //[nJet]
   Float_t         Jet_btagUParTAK4TauVJet[21];   //[nJet]
   Float_t         Jet_btagUParTAK4UDG[21];   //[nJet]
   Float_t         Jet_btagUParTAK4probb[21];   //[nJet]
   Float_t         Jet_btagUParTAK4probbb[21];   //[nJet]
   Float_t         Jet_chEmEF[21];   //[nJet]
   Float_t         Jet_chHEF[21];   //[nJet]
   Float_t         Jet_eta[21];   //[nJet]
   Float_t         Jet_hfEmEF[21];   //[nJet]
   Float_t         Jet_hfHEF[21];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[21];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[21];   //[nJet]
   Float_t         Jet_mass[21];   //[nJet]
   Float_t         Jet_muEF[21];   //[nJet]
   Float_t         Jet_muonSubtrDeltaEta[21];   //[nJet]
   Float_t         Jet_muonSubtrDeltaPhi[21];   //[nJet]
   ...
   Float_t         LHE_AlphaS;
   Int_t           nLHEPart;
   Short_t         LHEPart_firstMotherIdx[8];   //[nLHEPart]
   Short_t         LHEPart_lastMotherIdx[8];   //[nLHEPart]
   Int_t           LHEPart_pdgId[8];   //[nLHEPart]
   Int_t           LHEPart_status[8];   //[nLHEPart]
   Int_t           LHEPart_spin[8];   //[nLHEPart]
   Float_t         LHEPart_pt[8];   //[nLHEPart]
   Float_t         LHEPart_eta[8];   //[nLHEPart]
   Float_t         LHEPart_phi[8];   //[nLHEPart]
   Float_t         LHEPart_mass[8];   //[nLHEPart]
   Float_t         LHEPart_incomingpz[8];   //[nLHEPart]
   Int_t           nLowPtElectron;
   Bool_t          LowPtElectron_convVeto[7];   //[nLowPtElectron]
   UChar_t         LowPtElectron_convWP[7];   //[nLowPtElectron]
   UChar_t         LowPtElectron_lostHits[7];   //[nLowPtElectron]
   Short_t         LowPtElectron_electronIdx[7];   //[nLowPtElectron]
   Short_t         LowPtElectron_photonIdx[7];   //[nLowPtElectron]
   ...
   Int_t           nPFCand;
   Int_t           PFCand_pdgId[215];   //[nPFCand]
   Float_t         PFCand_eta[215];   //[nPFCand]
   Float_t         PFCand_mass[215];   //[nPFCand]
   Float_t         PFCand_phi[215];   //[nPFCand]
   Float_t         PFCand_pt[215];   //[nPFCand]
   Float_t         PFMET_covXX;
   Float_t         PFMET_covXY;
   Float_t         PFMET_covYY;
   Float_t         PFMET_phi;
   ...
   Short_t         Photon_seediEtaOriX[8];   //[nPhoton]
   Short_t         Photon_seediPhiOriY[8];   //[nPhoton]
   ...
   Float_t         Photon_hoe_Tower[8];   //[nPhoton]
   ...
   Float_t         Photon_superclusterEta[8];   //[nPhoton]
   ...
   Int_t           nTauProd;
   Short_t         TauProd_tauIdx[22];   //[nTauProd]
   Int_t           TauProd_pdgId[22];   //[nTauProd]
   Float_t         TauProd_eta[22];   //[nTauProd]
   Float_t         TauProd_phi[22];   //[nTauProd]
   Float_t         TauProd_pt[22];   //[nTauProd]
   ...
   Float_t         TrackGenJetAK4_eta[20];   //[nTrackGenJetAK4]
   Float_t         TrackGenJetAK4_phi[20];   //[nTrackGenJetAK4]
   Float_t         TrackGenJetAK4_pt[20];   //[nTrackGenJetAK4]
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[74];   //[nTrigObj]
   UShort_t        TrigObj_id[74];   //[nTrigObj]
   Int_t           TrigObj_l1iso[74];   //[nTrigObj]
   ULong64_t       TrigObj_filterBits[74];   //[nTrigObj]
   Float_t         TrigObj_pt[74];   //[nTrigObj]
   Float_t         TrigObj_eta[74];   //[nTrigObj]
   Float_t         TrigObj_phi[74];   //[nTrigObj]
   Float_t         TrigObj_l1pt[74];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[74];   //[nTrigObj]
   Float_t         TrigObj_l2pt[74];   //[nTrigObj]
   Float_t         TrkMET_phi;
   Float_t         TrkMET_pt;
   ...
   Float_t         Electron_IPx[7];   //[nElectron]
   Float_t         Electron_IPy[7];   //[nElectron]
   Float_t         Electron_IPz[7];   //[nElectron]
   Float_t         Electron_ipLengthSig[7];   //[nElectron]
   ...
   UChar_t         GenJet_nBHadrons[19];   //[nGenJet]
   UChar_t         GenJet_nCHadrons[19];   //[nGenJet]
   Short_t         GenJet_partonFlavour[19];   //[nGenJet]
   Float_t         GenVtx_t0;
   UChar_t         Jet_hadronFlavour[21];   //[nJet]
   Short_t         Jet_genJetIdx[21];   //[nJet]
   Short_t         Jet_partonFlavour[21];   //[nJet]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/cms/data/store/mc/RunIII2024Summer24NanoAODv15/GluGluH-01J-HToAATo4B_Par-M-35_TuneCP5_13p6TeV_madgraph-pythia8/NANOAODSIM/150X_mcRun3_2024_realistic_v2-v2/2520000/0afb91ad-bf79-4830-ba1a-ebb5b2a0b4b4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/cms/data/store/mc/RunIII2024Summer24NanoAODv15/GluGluH-01J-HToAATo4B_Par-M-35_TuneCP5_13p6TeV_madgraph-pythia8/NANOAODSIM/150X_mcRun3_2024_realistic_v2-v2/2520000/0afb91ad-bf79-4830-ba1a-ebb5b2a0b4b4.root");
      }
