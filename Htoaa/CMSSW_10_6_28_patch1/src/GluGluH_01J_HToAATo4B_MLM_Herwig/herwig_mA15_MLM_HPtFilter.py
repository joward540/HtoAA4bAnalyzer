...
# with command line options: Configuration/GenProduction/python/JME-RunIISummer20UL18wmLHEGEN-00024-fragment.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --python_filename JME-RunIISummer20UL18wmLHEGEN-00024_1_cfg.py --fileout file:JME-RunIISummer20UL18wmLHEGEN-00024.root --number 200 --number_out 200 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/JME-RunIISummer20UL18wmLHEGEN-00024-fragment.py nevts:200'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JME-RunIISummer20UL18wmLHEGEN-00024.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JME-RunIISummer20UL18wmLHEGEN-00024_inLHE.root'),
...
process.genSelectorH = cms.EDFilter("GenParticleSelector",
    cut = cms.string('pdgId() == 25 && statusFlags().isLastCopy()==1'),
    filter = cms.bool(True),
    src = cms.InputTag("genParticlesForFilter")
)

## Select only Higgs with pT > 150 GeV
process.highPtHs = cms.EDFilter("EtaPtMinCandViewSelector",
...
process.selectedHighPtHiggsCandFilter = cms.EDFilter("CandViewCountFilter",
    minNumber = cms.uint32(1),
    src = cms.InputTag("highPtHs")
)

process.ProductionFilterSequence = cms.Sequence(process.generator * (process.genParticlesForFilter + process.genSelectorH + process.highPtHs + process.selectedHighPtHiggsCandFilter))
