#!/bin/sh
# ./submitJobs_privSig_GENtoprivNanov15.sh DarkHiggsToWW_Zp2000_s200_Chi200_fragment.py 1000 50
#
fragFile=$1
...
nJobs=$3
#########
outFileDest="root://cmseos.fnal.gov//store/user/lpchadwxmet/Run2Run3/privateSamples_RunIII2024Summer24/${model}/"
...
#########
exeAtWorker="wraper.sh"
filesToTransfer="worker_privSig_GENtoprivNanov15.sh,${fragFile},step2_cfg.py,step3_cfg.py,step4_cfg.py,NanoTuples_Run3_2024_parT3.tar"
