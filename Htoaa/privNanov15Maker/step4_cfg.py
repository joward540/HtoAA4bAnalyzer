...
# with command line options: --era Run3_2024 --customise Configuration/DataProcessing/Utils.addMonitoring --step PAT --geometry DB:Extended --conditions 150X_mcRun3_2024_realistic_v2 --datatier MINIAODSIM --eventcontent MINIAODSIM1 --python_filename step4_cfg.py --fileout file:miniAODFile.root --filein file:step3.root --nThreads 8 --number -1 --number_out -1 --no_exec --mc
...
process.MINIAODSIM1output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:miniAODFile.root'),
