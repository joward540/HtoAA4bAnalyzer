...
_default_cfg = {
    ...
    'keepBranchMap': {
        ...
        'GlobalParticleTransformerV3FullScore': [
            ...
            'probRawHWxWxcscs', 'probRawHWxWxcsqq', 'probRawHWxWxqqqq', 'probRawHWxWxcsc', 'probRawHWxWxcss', 'probRawHWxWxcsq', 'probRawHWxWxqqc', 'probRawHWxWxqqs', 'probRawHWxWxqqq', 'probRawHZxZxbbbb', 'probRawHZxZxbbcc', 'probRawHZxZxbbss', 'probRawHZxZxbbqq', 'probRawHZxZxcccc', 'probRawHZxZxccss', 'probRawHZxZxccqq', 'probRawHZxZxssss', 'probRawHZxZxssqq', 'probRawHZxZxqqqq', 'probRawHZxZxbbb', 'probRawHZxZxbbc', 'probRawHZxZxbbs', 'probRawHZxZxbbq', 'probRawHZxZxccb', 'probRawHZxZxccc', 'probRawHZxZxccs', 'probRawHZxZxccq', 'probRawHZxZxssb', 'probRawHZxZxssc', 'probRawHZxZxsss', 'probRawHZxZxssq', 'probRawHZxZxqqb', 'probRawHZxZxqqc', 'probRawHZxZxqqs', 'probRawHZxZxqqq', 'probRawQCDbb', 'probRawQCDcc', 'probRawQCDb', 'probRawQCDc', 'probRawQCDothers',
