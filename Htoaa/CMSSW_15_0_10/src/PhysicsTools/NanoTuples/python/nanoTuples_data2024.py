...
# with command line options: --python_filename nanoTuples_data2024.py --eventcontent NANOAOD --customise PhysicsTools/NanoTuples/nanoTuples_cff.nanoTuples_customizeData --datatier NANOAOD --fileout file:nanoAODFile.root --conditions 150X_dataRun3_v2 --step NANO --scenario pp --filein file:miniAODFile.root --era Run3_2024 --data -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:miniAODFile.root'),
    secondaryFileNames = cms.untracked.vstring()
)

goodJSON = 'Cert_Collisions2024_378981_386951_Golden.json'
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:nanoAODFile.root'),
